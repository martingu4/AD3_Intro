...
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports ADC_CS_spy]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports ADC_Sclk_spy]
